...
namespace FinalLFA
{
    public partial class Form2 : Form
    {
        ...
        public Form2(string file)
        {
            ...
            CodeBox.Items.Add(" {");
            CodeBox.Items.Add("     string FilePath, EntryText;");
            ...
            CodeBox.Items.Add("     Console.WriteLine(\"Validador de tokens. Arrastre el archivo a evaluar:\");");
            CodeBox.Items.Add("     FilePath = Console.ReadLine();");
            CodeBox.Items.Add("     var Reader = new StreamReader(FilePath);");
            CodeBox.Items.Add("     EntryText = Reader.ReadLine().Trim();;");
            CodeBox.Items.Add("     Reader.Close();");
            CodeBox.Items.Add("     Console.WriteLine();");
            CodeBox.Items.Add("     Console.WriteLine(EntryText);");
        ...
        private void BtnCompile_Click(object sender, EventArgs e)
        {
            ...
            Writer.WriteLine("{");
            Writer.WriteLine("string FilePath, EntryText;");
            ...
            Writer.WriteLine("Console.WriteLine(\"Validador de tokens. Arrastre el archivo a evaluar:\");");
            Writer.WriteLine("FilePath = Console.ReadLine();");
            Writer.WriteLine("var Reader = new StreamReader(FilePath);");
            Writer.WriteLine("EntryText = Reader.ReadLine();");
            Writer.WriteLine("Reader.Close();");
            Writer.WriteLine("Console.WriteLine();");
            Writer.WriteLine("Console.WriteLine(EntryText);");
